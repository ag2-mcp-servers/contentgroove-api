...
from models import (
    ...
    Filter,
    Page,
    ProvidedURLInWebhookSubscriptionsPostRequest,
    Sort,
)
...
app = MCPProxy(
    ...
    version='1.0.0',
    servers=[{'description': 'API server', 'url': 'https://api.contentgroove.com'}],
)


@app.get(
    '/api/v1/clips',
    tags=['clip_operations', 'media_item_handling'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def get_api_v1_clips(
...
def post_api_v1_clips(body: ApiV1ClipsPostRequest):
    """
    create clip
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def delete_api_v1_clips__id(id: str):
    """
    delete clip
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.get(
    '/api/v1/clips/{id}',
    tags=['clip_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def get_api_v1_clips__id(id: str):
    """
    show clip
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def put_api_v1_clips__id(id: str, body: ApiV1ClipsIdPutRequest = ...):
    """
    update clip
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.get(
    ...
    tags=['upload_url_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def get_api_v1_direct_uploads():
    """
...
@app.get(
    '/api/v1/medias',
    tags=['media_item_handling'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def get_api_v1_medias(
    filter: Optional[Filter] = None,
    page: Optional[Page] = None,
    sort: Optional[Sort] = None,
):
...
def post_api_v1_medias(body: ApiV1MediasPostRequest):
    """
    create media
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.delete(
    '/api/v1/medias/{id}',
    tags=['media_item_handling', 'clip_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def delete_api_v1_medias__id(id: str):
    """
    delete media
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def get_api_v1_medias__id(id: str):
    """
    show media
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def put_api_v1_medias__id(id: str, body: ApiV1MediasIdPutRequest = ...):
    """
    update media
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def get_api_v1_webhook_subscriptions(
    filter: Optional[Filter] = None, sort: Optional[Sort] = None
):
    """
...
def post_api_v1_webhook_subscriptions(body: ApiV1WebhookSubscriptionsPostRequest):
    """
...
def delete_api_v1_webhook_subscriptions__id(id: str):
    """
...
def get_api_v1_webhook_subscriptions__id(id: str):
    """
